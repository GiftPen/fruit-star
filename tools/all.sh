...
fail=0
typeset -a broke
for t in js-check rules-test items-test hud-fit device-fit sound-test i18n-test tutorial-test relic-audit ads-test dev-test erode-test spawnbuy-test dt-test storage-test offline-test wide-fit juice-test plate-test combo-test odds-test hudrow-test forcedark-test save-test coin-test coinfly-test art-check book-test menufx-test stack-test pair-audit smoke; do
  printf "%-15s " "$t"
